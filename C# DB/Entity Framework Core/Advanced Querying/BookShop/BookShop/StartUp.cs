namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        public static string GetBooksByAgeRestriction(BookShopContext context, string command)
        {
            ...
            var input = command.First().ToString().ToUpper() + command.Substring(1).ToLower();

            var age = Enum.Parse<AgeRestriction>(input);

            var result = context
                .Books
                .Where(b => b.AgeRestriction.Equals(age))
                .Select(b => new
                {
                    title = b.Title
                })
        ...
        public static string GetBooksReleasedBefore(BookShopContext context, string date)
        {
            ...
            var dateTime = DateTime
                        .ParseExact(date, "dd-MM-yyyy", System.Globalization.CultureInfo.InvariantCulture);
